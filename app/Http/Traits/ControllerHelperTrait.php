...
trait ControllerHelperTrait
{
    public function index()
    {
        ...
        return $this->makeResponse($this->getView(), compact('list'));
    }
    ...
    public function show($id)
    {
        ...
        return $this->makeResponse($this->getView(), compact('item'));
    }
    ...
    protected function makeResponse($template, $data)
    {
        return request()->ajax() ? response()->json($data) : view($template, $data);
    }
