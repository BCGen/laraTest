...
module.exports = function(h, modules, classes, slots) {
  ...
  var genericFilter = this.hasGenericFilter
    ? h('div', { class: 'VueTables__search-field' }, [
  ...
  var perpage =
    perpageValues.length > 1
      ? h('div', { class: 'VueTables__limit-field' }, [
        h(
          'label',
          {
            class: classes.label,
  ...
  var dropdownPagination =
    this.opts.pagination && this.opts.pagination.dropdown
      ? h('div', { class: 'VueTables__pagination-wrapper' }, [
        h(
          'div',
          {
            class:
  ...
  var columnsDropdown = this.opts.columnsDropdown
    ? h('div', { class: 'VueTables__columns-dropdown-wrapper' }, [
      modules.columnsDropdown(classes)
    ])
    : ''

  var footerHeadings = this.opts.footerHeadings
    ? h('tfoot', [h('tr', [modules.headings(classes.right)])])
    : ''
  ...
  return h('div', { class: 'VueTables VueTables--' + this.source }, [
    tableTop,
    slots.beforeTable,
    h('div', { class: 'table-responsive' }, [
      h(
        ...
        [
          h('thead', [
            h('tr', [modules.headings(classes.right)]),
            slots.beforeFilters,
    ...
    slots.afterTable,
    modules.pagination(
      (0, _merge2.default)(classes.pagination, {
        wrapper:
          classes.row + ' ' + classes.column + ' ' + classes.contentCenter,
        nav: classes.center,
